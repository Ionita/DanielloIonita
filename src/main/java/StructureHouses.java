...
//        SparkWorker.getInstance().initSparkContext("query1", "local[*]");
        ...
        TimeClass.getInstance().stop(OUTPUT_DIRECTORY + "/query1results.csv");
...
//        SparkWorker.getInstance().closeConnection();
    ...
    private static void query2(){
        ...
        TimeClass.getInstance().stop(OUTPUT_DIRECTORY + "/query2results.csv");
    }
    ...
    private static void query3(){
        ...
        //plugsFinalValues.foreach(x -> System.out.println(x._1));
        ...
        //averageTopTime.foreach(x -> System.out.println("house: " + x._1 + ", top value: " + x._2));
        ...
        //averageDownTime.foreach(x -> System.out.println("house: " + x._1 + ", down value: " + x._2));
        ...
        TimeClass.getInstance().stop(OUTPUT_DIRECTORY + "/query3results.csv");
